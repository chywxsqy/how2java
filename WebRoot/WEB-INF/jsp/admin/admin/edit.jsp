			...
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">姓名： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input type="text" id="adminName"
						value="${map.adminName }" name="adminName" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">高校： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input type="text" id="company"
						value="${map.company }" name="company" /></td>
				</tr>
				<tr height="25">
