			...
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">性别： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text" value="${map.sex }"
						name="sex" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">学历： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text" value="${map.xlId }"
						name="xlId" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">岗位： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text" value="${map.gwId }"
						name="gwId" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">薪水： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text" value="${map.fwId }"
						name="fwId" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">简介： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text"
						value="${map.content }" name="content" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">详细简历： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text"
						value="${map.fileUrl }" name="fileUrl" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">是否会员： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text"
						value="${map.huiyuan }" name="huiyuan" /></td>
				</tr>
