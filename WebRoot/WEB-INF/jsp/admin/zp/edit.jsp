	...
	<form id="form1" name="form1" action="" method="post">
		...
		<center>
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">工作地点： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2">
					<select name="gzddId">
							<c:forEach items="${gzddList }" var="lists">
								<option value="${lists.id }" ${map.gzddId==lists.id?'selected':'' }>${lists.v1
									}</option>
							</c:forEach>
					</select>							
						</td>
				...
				<tr height="25">
					...
					<select name="gzjyId">
							<c:forEach items="${gzjyList }" var="lists">
								<option value="${lists.id }" ${map.gzjyId==lists.id?'selected':'' }>${lists.v1
									}</option>
							</c:forEach>
					</select>							
						</td>
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">行业领域： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2">
					<select name="hylyId">
							<c:forEach items="${hylyList }" var="lists">
								<option value="${lists.id }" ${map.hylyId==lists.id?'selected':'' }>${lists.v1
									}</option>
							</c:forEach>
					</select>							
						</td>
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">技能要求： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2">
					<textarea rows="5" cols="50" name="jn">${map.jn }</textarea>	
						</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">高校名称： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text"
						value="${map.title }" name="title" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">高校简介： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">招聘人数： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text"
						value="${map.number }" name="number" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">高校地点： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2"><input type="text"
				...
				<%--
				<tr height="25">
					<td class="outDetail" style="width: 30%">是否会员才能查看： <label
						style="font-weight: bold; color: red"> * </label></td>
					<td class="outDetail2">
					<select name="huiyuan">
